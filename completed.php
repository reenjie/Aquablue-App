...
<button class="btn btn-success mb-2" style="font-size:13px" onclick="window.location.href='index.php?Completed' ">Completed</button>
...
<h6 style=" " class="text-success">Completed Orders</h6>
<?php 
$token = $_SESSION['user_id'];
$order = new Order();
$users = new Users();
$fetchorder = $order -> ShowOrders($con,$token,'3');    
...
if($fetchorder){
  ...
  <li class="nav-item">
    <a class="nav-link active text-light bg-success " style="font-size:13px" aria-current="page" href="#"><?php echo 'ORDER NO '.$row['tid']?></a>
  </li>
...
<div class="card mb-2 shadow bg-light">
    ...
    <span style="font-size:18" class="text-secondary ">
                            ...
                            <span style="font-size:20px" class="text-success">Completed</span>
                        </span>
