...
<button class="btn btn-light text-dark d-none" id="slideright" style="font-size: 10px;position:fixed;top:60px"><i class="fas fa-bars"></i></button>
      ...
      <div class="main_contents">
         <div class="container " >
          ...
          ?>
        <div class="btn-group" >
<button class="btn btn-secondary mb-2" style="font-size:13px" onclick="window.location.href='orders.php' ">My Orders</button>
          ...
          foreach ($fetchorder as $row) {
            ...
            $fetchuser = $user ->fetchuser($con,$uid);
              foreach ($fetchuser as $usern) {
                ?>  
                <tr class="table-danger"><td colspan="5">
                <h6>Order#<?php echo $row['tid']?>  </h6>
                </td></tr>
                <tr class="bg-light">
                  <td  class=" text-danger"><?php echo $usern['name']?> 
                  <br>
