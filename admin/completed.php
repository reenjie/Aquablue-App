...
<button class="btn btn-success mb-2" style="font-size:13px" onclick="window.location.href='completed.php' ">Completed</button>

<button class="btn btn-light text-danger mb-2" onclick="window.location.href='cancelled.php' " style="font-size:13px">Cancelled </button>
</div>
          ...
          foreach ($fetchorder as $row) {
            ...
            if($fetchuser){
              ...
              foreach ($fetchuser as $usern) {
                ...
                <tr class="bg-light">
                  <td colspan="5" class=" text-danger"><?php echo $usern['name']?>
                  <br>
